...
class NgxColorConverterService {
    constructor() {
        this.values = '';
...
class NgxColorConverterComponent {
}
NgxColorConverterComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxColorConverterComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
NgxColorConverterComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.9", type: NgxColorConverterComponent, selector: "lib-ngx-color-converter", ngImport: i0, template: `
    <p>
      ngx-color-converter works!
    </p>
  `, isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxColorConverterComponent, decorators: [{
            type: Component,
            args: [{ selector: 'lib-ngx-color-converter', template: `
    <p>
      ngx-color-converter works!
    </p>
  ` }]
...
class NgxColorConverterModule {
}
NgxColorConverterModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxColorConverterModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NgxColorConverterModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.9", ngImport: i0, type: NgxColorConverterModule, declarations: [NgxColorConverterComponent], exports: [NgxColorConverterComponent] });
NgxColorConverterModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxColorConverterModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxColorConverterModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
...
export { NgxColorConverterComponent, NgxColorConverterModule, NgxColorConverterService };
//# sourceMappingURL=ngx-color-converter.mjs.map
