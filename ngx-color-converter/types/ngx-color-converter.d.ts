...
declare class NgxColorConverterService {
    values: string;
    red: number;
    green: number;
    blue: number;
...
declare class NgxColorConverterComponent {
    static ɵfac: i0.ɵɵFactoryDeclaration<NgxColorConverterComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxColorConverterComponent, "lib-ngx-color-converter", never, {}, {}, never, never, true, never>;
}
