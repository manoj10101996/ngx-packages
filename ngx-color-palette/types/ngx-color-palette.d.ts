...
declare class NgxColorPaletteService {
    constructor();
    static ɵfac: i0.ɵɵFactoryDeclaration<NgxColorPaletteService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<NgxColorPaletteService>;
}

declare class NgxColorPaletteComponent implements AfterViewInit {
    private elementRef;
    color: string;
    squared: boolean;
    position: string;
