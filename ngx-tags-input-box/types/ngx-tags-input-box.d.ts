...
declare class NgxTagsInputBoxService {
    constructor();
    static ɵfac: i0.ɵɵFactoryDeclaration<NgxTagsInputBoxService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<NgxTagsInputBoxService>;
}

type mode = "primary" | "success" | "danger" | "info" | "warning" | "light";
declare class NgxTagsComponent {
